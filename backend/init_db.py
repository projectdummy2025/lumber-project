...
SEED = [
    ...
    ("inventory_materials",
     ...
     [('MAT-TEAK-LOG', 'Raw Teak Logs Grade A', 'Timber Log', 90.00, 'm3', 26.0, 45.0),
      ('MAT-MAHOG-LOG', 'Raw Mahogany Logs', 'Timber Log', 45.00, 'm3', 22.0, 50.0),
      ('MAT-TEAK-DRY', 'Kiln-Dried Teak Sawn Timber', 'Sawn Board', 15.00, 'm3', 12.0, 85.0)]),
    ("workstations",
